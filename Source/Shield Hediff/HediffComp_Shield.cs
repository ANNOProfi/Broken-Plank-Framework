...
namespace BrokenPlankFramework
{
    public class HediffComp_Shield : HediffComp_Renderable, IDamageResponse
    {
        ...
        public override void CompExposeData()
        {
            ...
            {
                BrokenPlankCache.AddCache(this, ref BrokenPlankCache.responderCache, Pawn.thingIDNumber);
            }
        }
        ...
        public override void CompPostPostRemoved()
        {
            ...
            BrokenPlankCache.RemoveCache(this, BrokenPlankCache.responderCache, Pawn.thingIDNumber);
        }
